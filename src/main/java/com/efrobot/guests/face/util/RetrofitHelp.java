...
//        String devicesId = DeviceUtil.getAndroidID(GuestsApplication.getAppContext()) + "+" + DeviceUtil.getIMEI(GuestsApplication.getAppContext());
...
//        @Multipart
//        @POST("v1/face_images")
//        Call<ResponseBody> postImage(@Part("dev_id") RequestBody var1, @Part MultipartBody.Part var2);
//    }
//
